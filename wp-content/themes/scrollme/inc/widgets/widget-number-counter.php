...
class WP_Scrollme_Number_Counter extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        ?>
            <div class="counter-wrap clearfix">
                <div class="counter-text"><?php echo $title; ?></div>
                <div class="counter-img clearfix">
                    <input type="text" data-width="100" data-fgColor="#df2c45" data-bgColor="#212c35" data-height="50" value="0" data-number="<?php echo $counter; ?>" min="0" max="100" class="ak-counter clearfix">
                </div>
            </div>
        <?php
        echo '</div>';
    ...
    public function form( $instance ) {
        ...
        ?>
            ...
            <?php _e('Counter Number', 'scrollme'); ?>
            </label>
            ...
            <div class="startKnob" style="display: none;"><?php _e( 'start', 'scrollme' ); ?></div>
