...
function scrollme_sidebar_layout_callback()
{
    ...
    <table class="form-table page-meta-box">
        <tr>
            <td colspan="4"><?php _e( 'Choose Sidebar Template', 'scrollme' ); ?></td>
        </tr>
...
function scrollme_save_sidebar_layout( $post_id ) {
    ...
    if ( !isset( $_POST[ 'scrollme_sidebar_layout_nonce' ] ) || !wp_verify_nonce( $_POST[ 'scrollme_sidebar_layout_nonce' ], basename( __FILE__ ) ) )
        return;
