 ...
 * Sidebar Displays
 */
function dinozoom_sidebar( $position ) {
	$site_layout =  get_theme_mod( 'site_layout', 1 );
	if (	 $site_layout == 1 && $position == 'right' ):
		get_sidebar();
	elseif ( $site_layout == 2 && $position == 'left' ):
		get_sidebar('left');
	elseif ( $site_layout == 3): // L C R
		if ( $position == 'left' ) get_sidebar('left');
		else get_sidebar();
	elseif ( $site_layout == 4 && $position == 'left' ): // R L C
		get_sidebar();
		get_sidebar('left');
	elseif ( $site_layout == 5 && $position == 'right' ): // C L R
		get_sidebar('left');
		get_sidebar();
	else:
		echo "<!-- No Sidebar -->";
